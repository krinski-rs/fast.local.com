			...
			<div className={ this.props.classes.root }>
			    ...
			    <main className={ this.props.classes.content }>
			        ...
			        <Container maxWidth="lg" className={ this.props.classes.container }>
						<Switch>
							<PrivateRoute path="/service/create" component={ServiceCreate} appState={ this.props.appState } update={ this.props.setAppState } />
							<PrivateRoute path="/service" component={ServiceList} appState={ this.props.appState } update={ this.props.setAppState } />
						</Switch>
			        </Container>
					<Footer />
			    </main>
