			...
			<div className={ this.props.classes.root }>
			    ...
			    <main className={ this.props.classes.content }>
			        ...
			        <Container maxWidth="lg" className={ this.props.classes.container }>
						<Switch>
							<PrivateRoute path="/pop/create" component={PopCreate} appState={ this.props.appState } update={ this.props.setAppState } />
							<PrivateRoute path="/pop" component={PopList} appState={ this.props.appState } update={ this.props.setAppState } />
						</Switch>
			        </Container>
					<Footer />
			    </main>
