...
import SwitchsCreate from './SwitchsCreate';
import SwitchsList from './SwitchsList';
import SwitchsView from './SwitchsView';
			...
			<div className={ this.props.classes.root }>
			    ...
			    <main className={ this.props.classes.content }>
			        ...
			        <Container maxWidth="lg" className={ this.props.classes.container }>
						<Switch>
							<PrivateRoute path="/switchs/create" component={SwitchsCreate} appState={ this.props.appState } update={ this.props.setAppState } />
							<PrivateRoute path="/switchs/:id" component={SwitchsView} appState={ this.props.appState } update={ this.props.setAppState } />
							<PrivateRoute path="/switchs" component={SwitchsList} appState={ this.props.appState } update={ this.props.setAppState } />
						</Switch>
			        </Container>
					<Footer />
			    </main>
